...
<script type="text/javascript">	
	function submit() {	 
		window.opener.document.getElementById("container").insertAdjacentHTML('afterbegin',"<img src='/mailProject/image/<%=realFileName%>' alt='업로드 이미지' id='resizable${cnt}' width='500px'>");
		opener.cntplus();		
	    self.close();		
	}
</script>
